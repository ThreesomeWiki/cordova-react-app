...
const IconXiaoxituisongpeizhi: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
...
IconXiaoxituisongpeizhi.defaultProps = {
  size: 0.2,
};

export default IconXiaoxituisongpeizhi;
